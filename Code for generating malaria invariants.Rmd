...
### Simulate Malaria Variants Data
```{r}
...
data <- predictors_df %>%
  mutate(Malaria_Variant = factor(malaria_variants, labels = c("Plasmodium_falciparum", "Plasmodium_vivax", "Plasmodium_malariae")))
